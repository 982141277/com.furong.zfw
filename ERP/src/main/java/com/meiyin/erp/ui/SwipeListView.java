...
public class SwipeListView extends ListView {
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			//System.out.println("onInterceptTouchEvent----->getFirstVisiblePosition():"+getFirstVisiblePosition());
			if (motionPosition >= 0) {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_CANCEL:
			...
			if (mIsHorizontal != null && mIsHorizontal && mCurrentItemView!=null) {
				//LogUtil.i("SwipeListView", "mIsHorizontal != null && mIsHorizontal 为true");
	...
	private void showRight(View view) {
		...
		if (mCurrentItemView == null || view==null || msg==null) {
			return;
		}
		msg.obj = view;
