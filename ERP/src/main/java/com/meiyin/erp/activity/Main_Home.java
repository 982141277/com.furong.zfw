...
public class Main_Home extends SlidingFragmentActivity implements View.OnClickListener {
	...
	private void startservice() {
		boolean isrun = AndroidUtil.isServiceRunning(context,
				"com.meiyin.erp.service.Meiyinservice");
		if (isrun) {
		...
		boolean isruns = AndroidUtil.isServiceRunning(context,
				"com.meiyin.erp.service.Watchservice");
		if (isruns) {
...
//			Image.ImageLoader(s.toString(), head_photo);
			head_photo.setImageDrawable(getResources().getDrawable(R.mipmap.loga));
		}
		head_photo.setImageDrawable(getResources().getDrawable(R.mipmap.loga));
		...
		// 首页
		page_linear.setOnClickListener(new View.OnClickListener() {
		...
		// 公告
		topic_relative.setOnClickListener(new View.OnClickListener() {
		...
		// 我的
		my_linear.setOnClickListener(new View.OnClickListener() {
	...
	private void item1(View item1) {
		...
		pagelist.add(new MyPage_Entity("待审批事项", String.valueOf(lons), true,getResources().getDrawable(R.mipmap.mshenpi)));
		pagelist.add(new MyPage_Entity("日志管理", "0", true,getResources().getDrawable(R.mipmap.mrizhi)));
		pagelist.add(new MyPage_Entity("外勤管理", "0", true,getResources().getDrawable(R.mipmap.mwaiqin)));
		pagelist.add(new MyPage_Entity("新增申请单", "0", true,getResources().getDrawable(R.mipmap.newoutlogos)));
		pagelist.add(new MyPage_Entity("所有申请单", "0", true,getResources().getDrawable(R.mipmap.alloutlogos)));
		...
		for (Get_Logins item : getlist) {
			if (item.getSystem_code().equals("92165969")) {
				...
				pagelist.add(new MyPage_Entity("待处理事件", String.valueOf(lonss),
						true,getResources().getDrawable(R.mipmap.mshijian)));
				pagelist.add(new MyPage_Entity("事件处理", "0", true,getResources().getDrawable(R.mipmap.allitlogos)));
				pagelist.add(new MyPage_Entity("巡检表", "0", true,getResources().getDrawable(R.mipmap.xjbs)));

				it = true;
			}
		}
		if(getIntent().getStringExtra("gooutbrush").equals("1")||getIntent().getStringExtra("gooutbrush").equals("2")){
		pagelist.add(new MyPage_Entity("项目考勤", "0", true,getResources().getDrawable(R.mipmap.xjb)));}
...
private class JsonHandlersize extends MJsonHttpHandler {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if (arg2 > 0) {
					if (topiclist.size() > 0) {
						...
						topicDao.insertOrReplace(topiclist.get(arg2 - 1));
	...
	private class JsonHandlerInit extends MJsonHttpHandler {
		...
		public void onSuccess(int statusCode, Header[] headers,
			...
			for (Topic_Entity topic_item : topic_memu) {
				topicDao.insertOrReplace(topic_item);
			}
	...
	private void item5(View item5) {
		...
		setlist.add(new Setting_Entity(getResources().getDrawable(
				R.mipmap.guanyu1), "关于美音"));
		setlist.add(new Setting_Entity(getResources().getDrawable(
				R.mipmap.yonghu1), "退出帐号"));
				...
				if (setlist.get(arg2).getName().equals("版本更新")) {
					...
					button_t.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View arg0) {
							...
							topicDao.deleteAll();
							AndroidUtil.LoginOut(activity,"正在退出");
								...
								if (null == fileEntity.getUser_code()) {
									...
									button_t.setOnClickListener(new OnClickListener() {
										...
										public void onClick(View arg0) {
											...
											AndroidUtil.requestPermission(Main_Home.this,phoneString);
	...
	private void setCurrent(int arg0, ImageView img, TextView text,
		...
		switch (arg0) {
		case 0:
			img.setBackground(getResources().getDrawable(R.mipmap.page2));
			// img1.setBackground(getResources().getDrawable(R.drawable.message1));
			img2.setBackground(getResources().getDrawable(R.mipmap.address1));
			img3.setBackground(getResources().getDrawable(R.mipmap.topic1));
			img4.setBackground(getResources().getDrawable(R.mipmap.my1));
		...
		// break;
		case 1:
			img.setBackground(getResources().getDrawable(R.mipmap.page1));
			// img1.setBackground(getResources().getDrawable(R.drawable.message1));
			img2.setBackground(getResources().getDrawable(R.mipmap.address2));
			img3.setBackground(getResources().getDrawable(R.mipmap.topic1));
			img4.setBackground(getResources().getDrawable(R.mipmap.my1));
			text.setTextColor(getResources().getColor(R.color.text_grays));
			// text1.setTextColor(getResources().getColor(R.color.text_grays));
		...
		case 2:
			...
			// img1.setBackground(getResources().getDrawable(R.drawable.message1));
			img2.setBackground(getResources().getDrawable(R.mipmap.address1));
			img3.setBackground(getResources().getDrawable(R.mipmap.topic2));
			img4.setBackground(getResources().getDrawable(R.mipmap.my1));
			text.setTextColor(getResources().getColor(R.color.text_grays));
			// text1.setTextColor(getResources().getColor(R.color.text_grays));
			text2.setTextColor(getResources().getColor(R.color.text_grays));
		...
		case 3:
			...
			img2.setBackground(getResources().getDrawable(R.mipmap.address1));
			img3.setBackground(getResources().getDrawable(R.mipmap.topic1));
			img4.setBackground(getResources().getDrawable(R.mipmap.my2));
			text.setTextColor(getResources().getColor(R.color.text_grays));
			// text1.setTextColor(getResources().getColor(R.color.text_grays));
			text2.setTextColor(getResources().getColor(R.color.text_grays));
			text3.setTextColor(getResources().getColor(R.color.text_grays));
	...
	public void onClick(View arg0) {
		...
		case R.id.imageView_setting:
			...
			setlist.add(new Setting_Entity(getResources().getDrawable(
					R.mipmap.gengxin), "版本更新"));
			// setlist.add(new
			// Setting_Entity(getResources().getDrawable(R.drawable.xiaoxitu),
			// "系统通知"));
			setlist.add(new Setting_Entity(getResources().getDrawable(
					R.mipmap.phonepic), "公司通讯"));
			setlist.add(new Setting_Entity(getResources().getDrawable(
					R.mipmap.guanyu), "关于美音"));
			setlist.add(new Setting_Entity(getResources().getDrawable(
					R.mipmap.yonghu), "退出帐号"));
			Setting_Adapter adapters = new Setting_Adapter(context);
			adapters.setList(setlist);
	...
	public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults)
	{
		switch (requestCode)
		{
			case  SPConstant.TAGCALLPHONE:
				if (grantResults[0] == PackageManager.PERMISSION_GRANTED)
				{
					Toast.makeText(Main_Home.this, "已授权拨打电话", Toast.LENGTH_SHORT).show();
				}
				else
				{
					Toast.makeText(Main_Home.this, "拨打电话功能被禁止", Toast.LENGTH_SHORT).show();
				}
				break;
			default:
